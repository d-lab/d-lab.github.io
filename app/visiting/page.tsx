    ...
    <div className="max-w-6xl mx-auto py-16 sm:py-20 px-4 sm:px-6">
      ...
      <header className="mb-12 pb-8 border-b border-slate-200 dark:border-slate-800">
        ...
        <p className="text-slate-600 dark:text-slate-300 max-w-3xl mt-4 leading-relaxed">
          If you are a current PhD student, we can provide some financial support for you to spend 2 or 3 months in Brisbane to work on a joint collaborative research project.<br />
...
<ul>
<li>A 1-2 page research proposal (in line with the proposed duration of stay), including clearly planned outcomes. Please indicate the linkage between the proposal and the research conducted by one or more members of DLab. The proposed research should be of high quality, for example something that could be published at a top conference or journal.</li>
<li>A 1-2 page CV highlighting key achievements, plus a full publications list (for journal papers, please indicate the impact factor; for conference papers, please refer to http://portal.core.edu.au/conf-ranks/ to find the rank of the conference, if available).</li>
<li>A draft budget of the expected costs and required funding. </li>
<li>Separately, as a final step the student’s supervisor must provide a letter of support, emailed directly to the contact address (below), including details of the provided co-funding. Please note that an application will not be considered complete until such a letter is received. </li>
</ul>
<br />
...
<br /><br />
          <b>Before submitting a complete application, it is recommended to get in touch with Prof. Gianluca Demartini at demartini@acm.org to check the viability of the proposed application.</b>
        </p>
      </header>
    </div>
  );
